...
**EXOMARE** (anche noto come progetto **ProDigi**) è un progetto di edizione digitale e analisi linguistica dedicato alla seconda prosificazione del *Roman de Troie en prose* (nota come **Prose 2**). 
...
*   **Testi Lemmatizzati**: Consultazione dei testi con annotazioni linguistiche realizzate tramite l'interfaccia **ULA** (*Universal Language Annotation*).
...
*   **Autore/Responsabile**: Giuseppe Materni
*   **Sviluppo Tecnico**: ProDigi Lab
*   **Host**: Hosted on GitHub Pages (`exomare.github.io`)

---
*Ultimo aggiornamento dei contenuti: Febbraio 2023*